...
window.onload = function() {
    ...
    var pathOptions = [{color: '#61B18C',opacity: 1,angle: -50, position: 'TL',x: -400,y: -600,scale: 1},
                        {color: '#B4E5CE',opacity: 0.5,angle: 0, position: 'BR',x: 100,y: 270,scale: 1.3},
                        {color: '#3AB78C',opacity: 0.47,angle: 0, position: 'BR',x: 400,y: 280,scale: 1.3},
                        {color: '#3AB78C',opacity: 0.61,angle: 180, position: 'TR',x: 300,y: -55,scale: 1}];
